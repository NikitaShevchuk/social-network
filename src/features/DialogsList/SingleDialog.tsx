...
const SingleDialog: FC<DialogWithMessage> = ({
    ...
    return (
        <NavLink to={`/messages/${id}`} className="dialogs-list__item opacity-animation">
            ...
            <span className="people-name">
                ...
                {body && <span className="dialog-message-text">{body}</span>}
            </span>
            {hasNewMessages && <div className="unread">{newMessagesCount}</div>}
        </NavLink>
    );
};
