...
export const getUsers =
    (currentPage: number, pageSize: number): AsyncThunkType =>
    async (dispatch) => {
...
export const followUser =
    (id: number): AsyncThunkType =>
    async (dispatch) => {
        await followUnfollowFlow(id, dispatch, usersActions.followSuccessful, usersService.follow);
    };
...
export const unfollowUser =
    ...
    async (dispatch) => {
        await followUnfollowFlow(
            id,
            dispatch,
            usersActions.unfollowSuccessful,
