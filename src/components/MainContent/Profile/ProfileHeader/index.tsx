...
const ProfileHeader: FC<Props> = ({
    ...
    const figureClassName =
        profileLargePhoto && !photoIsUpdating ? style.transparent : style.whiteBg;
        ...
        <div className={style.profileHeader}>
            <div className={style.userAvatar}>
                <figure className={figureClassName}>
                    {photoIsUpdating ? <Preloader /> : <UserPhoto profileImg={profileLargePhoto} />}
                    {isMyProfile && <EditProfilePhoto onPhotoUpload={onPhotoUpload} />}
                </figure>
            </div>
