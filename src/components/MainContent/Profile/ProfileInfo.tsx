...
const ProfileInfo: FC<Props> = memo(({ profile, isMyProfile, profileEditMode }) => {
    const jobBlockClassName = profile.lookingForAJob ? style.green : style.red;
    return (
        <div
            className={classNames(style.profileData, profileEditMode ? style.hidden : style.shown)}
        >
            ...
            <div className="timeline-info__row">
                <div className="lookingForAJob">
                    ...
                    <div className={style.jobStyle}>
                        <FontAwesomeIcon icon={`fa fa-briefcase` as any} className={style.icon} />
                        Job status:
